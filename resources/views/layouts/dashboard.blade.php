...
<head>
    ...
    <title>Inventory Software - weXpart</title>
...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <footer class="site-footer">
            <div class="footer-inner bg-white">
                <div class="row">
                    <div class="col-sm-6">
                        Copyright &copy; {{ now()->format('Y') }} <span class="text-success">weXpart</span> Admin
                    </div>
                    <div class="col-sm-6 text-right">
                        Designed by <a class="text-success" href="https://github.com/Fahim-Hossain-Munna">weXpart</a>
                    </div>
                </div>
            </div>
        </footer>
    ...
    <script src="{{ asset('dashboard_assets') }}/assets/js/init/weather-init.js"></script>

    <script src="https://cdn.jsdelivr.net/npm/moment@2.22.2/moment.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@3.9.0/dist/fullcalendar.min.js"></script>
    <script src="{{ asset('dashboard_assets') }}/assets/js/init/fullcalendar-init.js"></script>
